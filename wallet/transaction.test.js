...
describe('Transaction', () => {
    ...
    describe('update()', () => {
        let originalSigniture, originalSenderOutput, nextRecipient, nextAmount;

        beforeEach(() => {
            originalSigniture = transaction.input.signiture;
        ...
        describe('and the amount is valid', () => {
            ...
            it('substracts the amount from original sender output amount', () => {
                expect(transaction.outputMap[senderWallet.publicKey])
            ...
            it('re-signs the transaction', () => {
                expect(transaction.input.signature).not.toEqual(originalSigniture);
            });
        });
        ...
        describe('and the amount is invalid', () => {
            it('throws an error', () => {
                expect(() => {
                    transaction.update({
                        senderWallet, recipint: 'foo', amount: 999999
                    })
        ...
        describe('and another update for the same recipient', () => {
            ...
            it('substracts the amount from original output amount', () => {
                expect(transaction.outputMap[senderWallet.publicKey])
